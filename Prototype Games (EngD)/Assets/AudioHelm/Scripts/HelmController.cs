...
namespace AudioHelm
{
    ...
    [
        HelpURL(
            "http://tytel.org/audiohelm/manual/class_audio_helm_1_1_helm_controller.html")
    ]
    public class HelmController : MonoBehaviour, NoteHandler
    {
        ...
        [
            Tooltip(
                "The native synth channel to send note events to." +
        ...
        protected float
                ...
                synthParamValue0 = 0.0f,
                synthParamValue1 = 0.0f,
                synthParamValue2 = 0.0f,
                synthParamValue3 = 0.0f,
                synthParamValue4 = 0.0f,
                synthParamValue5 = 0.0f,
                synthParamValue6 = 0.0f,
                synthParamValue7 = 0.0f,
                synthParamValue8 = 0.0f,
                synthParamValue9 = 0.0f,
                synthParamValue10 = 0.0f,
                synthParamValue11 = 0.0f,
                synthParamValue12 = 0.0f,
                synthParamValue13 = 0.0f,
                synthParamValue14 = 0.0f,
                synthParamValue15 = 0.0f;
        ...
        Dictionary<float, int>
            pressedFrequencies = new Dictionary<float, int>();
        ...
        public void LoadPatch(HelmPatch patch)
        {
            ...
            foreach (FieldInfo field in fields)
            {
                ...
                {
                    float val =
                        (float) field.GetValue(patch.patchData.settings);
            ...
            foreach (HelmModulationSetting
                modulation
                in
                patch.patchData.settings.modulations
            )
            {
        ...
        {
            if (index >= synthParameters.Count) return 0.0f;

            // Note: These are listed out to support Unity animations.
            switch (index)
            {
                case 0:
                    return synthParamValue0;
                case 1:
                    return synthParamValue1;
                case 2:
                    return synthParamValue2;
                case 3:
                    return synthParamValue3;
                case 4:
                    return synthParamValue4;
                case 5:
                    return synthParamValue5;
                case 6:
                    return synthParamValue6;
                case 7:
                    return synthParamValue7;
                case 8:
                    return synthParamValue8;
                case 9:
                    return synthParamValue9;
                case 10:
                    return synthParamValue10;
                case 11:
                    return synthParamValue11;
                case 12:
                    return synthParamValue12;
                case 13:
                    return synthParamValue13;
                case 14:
                    return synthParamValue14;
                case 15:
                    return synthParamValue15;
                default:
                    return 0.0f;
            }
        }
        ...
        {
            if (index >= synthParameters.Count) return;

            // Note: These are listed out to support Unity animations.
            switch (index)
            {
                case 0:
                    synthParamValue0 = newValue;
                    break;
                case 1:
                    synthParamValue1 = newValue;
                    break;
                case 2:
                    synthParamValue2 = newValue;
                    break;
                case 3:
                    synthParamValue3 = newValue;
                    break;
                case 4:
                    synthParamValue4 = newValue;
                    break;
                case 5:
                    synthParamValue5 = newValue;
                    break;
                case 6:
                    synthParamValue6 = newValue;
                    break;
                case 7:
                    synthParamValue7 = newValue;
                    break;
                case 8:
                    synthParamValue8 = newValue;
                    break;
                case 9:
                    synthParamValue9 = newValue;
                    break;
                case 10:
                    synthParamValue10 = newValue;
                    break;
                case 11:
                    synthParamValue11 = newValue;
                    break;
                case 12:
                    synthParamValue12 = newValue;
                    break;
                case 13:
                    synthParamValue13 = newValue;
                    break;
                case 14:
                    synthParamValue14 = newValue;
                    break;
                case 15:
                    synthParamValue15 = newValue;
                    break;
            }
        }
        ...
        {
            if (index >= synthParameters.Count || index < 0) return;
            float[] paramValues =
            {
                synthParamValue0,
                synthParamValue1,
        ...
        {
            if (synthParameters.Count >= MAX_PARAMETERS) return null;
        ...
        public HelmParameter AddParameter(Param parameter)
        {
            ...
            SetParameterAtIndex(synthParameters.Count,
            synthParameter.paramValue);
            synthParameters.Add (synthParameter);
            return synthParameter;
        }
        ...
        {
            Native
                .HelmSetParameterPercent(channel, (int) parameter, newPercent);
        }
        ...
        void FixedUpdate()
        {
            ...
            if (Time.timeSinceLevelLoad > UPDATE_WAIT) UpdateAllParameters();
        }
    }
}
